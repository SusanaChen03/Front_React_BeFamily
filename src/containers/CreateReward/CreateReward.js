    ...
    <div>
      <div>
        ...
        <form onSubmit={(e) => formSubmit(e)}>
          <div>
            <label className="labelrw" htmlFor="rewardName">Nombre de la recompensa</label>
            <input type="text" id="rewardName" name="rewardName" className="resRegister" />

            <label className="labelrw" htmlFor="rewardUrl">URL de la recompensa</label>
            <input
              type="text"
              id="rewardUrl"
              name="rewardUrl"
              placeholder="Buscar una imagen para tu recompensa" className="resRegister"
            />

            <label className="labelrw" htmlFor="description">Descripción</label>
            <input type="text" id="description" name="description" className="resRegister" />
            <div className="ColorActive">
            <div  className="input-group divColor">  
                  <label className="chcolor  input-group-text" htmlFor="repetition" for="color">Color</label>
                  <select  className="form-select chcolor" id="color" name="color" >
                      <option value="#F7327E">Rosa</option>
                      <option value="#4D9BE8" selected>Azul</option>
